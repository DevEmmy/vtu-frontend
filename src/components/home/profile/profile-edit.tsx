...
type ProfileTitle = 'firstName' | 'lastName' | 'email' | 'phoneNumber' 

function profileEdit() {
    const profileTitle = ['First Name', "Last Name", 'Email', 'Phone Number']
    ...
    return (
        <div className='relative px-3 py-5 flex flex-col gap-7 min-h-screen'>
            ...
            <div className='flex justify-center mt-10'>
                <button onClick={()=> updateProfileFn(profile)} className='text-white bg-primary py-3 px-8 rounded-3xl'>Save Changes</button>
            </div>
