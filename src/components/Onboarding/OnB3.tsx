        ...
        <div className='pb-3 flex flex-col '>
            ...
            <div className="onboarding_container">
                ...
                <Link to={"/login"} className='w-full'>
                    <button className=' bg-primary text-white font-semimedium py-3 px-10 w-full rounded-full'>
                        Login
                    </button>
                </Link>

                <Link to={"/new-account"} className='w-full'>
                    <button className='border border-primary text-primary font-semimedium py-3 px-10 w-full rounded-full'>
                        Sign up
                    </button>
                </Link>
